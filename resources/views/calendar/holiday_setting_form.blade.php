            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post"
                            action="{{ route('update_holiday_setting') }}">
                            @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio"
                                            name="flag_tue"
                                            value="{{ $FLAG_OPEN }}"
                                            {{ $setting->isOpenTuesday() ? 'checked' : '' }}
                                            id="flag_tue_open" />
                                        <label for="flag_tue_open">営業日</label>
                                        <input type="radio"
                                            name="flag_tue"
                                            value="{{ $FLAG_CLOSE }}"
                                            {{ $setting->isCloseTuesday() ? 'checked' : '' }}
                                            id="flag_tue_close" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio"
                                            name="flag_wed"
                                            value="{{ $FLAG_OPEN }}"
                                            {{ $setting->isOpenWednesday() ? 'checked' : '' }}
                                            id="flag_wed_open" />
                                        <label for="flag_wed_open">営業日</label>
                                        <input type="radio"
                                            name="flag_wed"
                                            value="{{ $FLAG_CLOSE }}"
                                            {{ $setting->isCloseWednesday() ? 'checked' : '' }}
                                            id="flag_wed_close" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio"
                                            name="flag_thu"
                                            value="{{ $FLAG_OPEN }}"
                                            {{ $setting->isOpenThursday() ? 'checked' : '' }}
                                            id="flag_thu_open" />
                                        <label for="flag_thu_open">営業日</label>
                                        <input type="radio"
                                            name="flag_thu"
                                            value="{{ $FLAG_CLOSE }}"
                                            {{ $setting->isCloseThursday() ? 'checked' : '' }}
                                            id="flag_thu_close" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio"
                                            name="flag_fri"
                                            value="{{ $FLAG_OPEN }}"
                                            {{ $setting->isOpenFriday() ? 'checked' : '' }}
                                            id="flag_fri_open" />
                                        <label for="flag_fri_open">営業日</label>
                                        <input type="radio"
                                            name="flag_fri"
                                            value="{{ $FLAG_CLOSE }}"
                                            {{ $setting->isCloseFriday() ? 'checked' : '' }}
                                            id="flag_fri_close" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio"
                                            name="flag_sat"
                                            value="{{ $FLAG_OPEN }}"
                                            {{ $setting->isOpenSaturday() ? 'checked' : '' }}
                                            id="flag_sat_open" />
                                        <label for="flag_sat_open">営業日</label>
                                        <input type="radio"
                                            name="flag_sat"
                                            value="{{ $FLAG_CLOSE }}"
                                            {{ $setting->isCloseSaturday() ? 'checked' : '' }}
                                            id="flag_sat_close" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio"
                                            name="flag_sun"
                                            value="{{ $FLAG_OPEN }}"
                                            {{ $setting->isOpenSunday() ? 'checked' : '' }}
                                            id="flag_sun_open" />
                                        <label for="flag_sun_open">営業日</label>
                                        <input type="radio"
                                            name="flag_sun"
                                            value="{{ $FLAG_CLOSE }}"
                                            {{ $setting->isCloseSunday() ? 'checked' : '' }}
                                            id="flag_sun_close" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio"
                                            name="flag_holiday"
                                            value="{{ $FLAG_OPEN }}"
                                            {{ $setting->isOpenHoliday() ? 'checked' : '' }}
                                            id="flag_holiday_ope" />
                                        <label for="flag_holiday_open">営業日</label>
                                        <input type="radio"
                                            name="flag_holiday"
                                            value="{{ $FLAG_CLOSE }}"
                                            {{ $setting->isCloseHoliday() ? 'checked' : '' }}
                                            id="flag_holiday_clos" />
